    ...
    public static class SourceOperations
    {
        ...
        public static SourceSubFlow<TOut, TMat> GroupBy<TOut, TMat, TKey>(this Source<TOut, TMat> flow, int maxSubstreams, Func<TOut, TKey> groupingFunc)
        {
            return new SourceSubFlowImpl<TOut, TMat>(
                flow.GroupBy(maxSubstreams, groupingFunc, (f, s) => ((Source<Source<TOut, NotUsed>, TMat>)f).To(s)));
        }
        ...
        {
            return new SourceSubFlowImpl<TOut, TMat>(
                flow.GroupBy(-1, groupingFunc, (f, s) => ((Source<Source<TOut, NotUsed>, TMat>)f).To(s)));
        }
        ...
        {
            return new SourceSubFlowImpl<TOut, TMat>(
                flow.SplitWhen(substreamCancelStrategy, predicate, (f, s) => ((Source<Source<TOut, NotUsed>, TMat>)f).To(s)));
        }
        ...
        {
            return new SourceSubFlowImpl<TOut, TMat>(
                flow.SplitAfter(substreamCancelStrategy, predicate, (f, s) => ((Source<Source<TOut, NotUsed>, TMat>)f).To(s)));
        }
