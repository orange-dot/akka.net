    ...
    public static class FlowOperations
    {
        ...
        public static FlowSubFlow<TIn, TOut, TMat> SplitWhen<TIn, TOut, TMat>(this Flow<TIn, TOut, TMat> flow, SubstreamCancelStrategy substreamCancelStrategy, Func<TOut, bool> predicate)
        {
            return new FlowSubFlowImpl<TIn, TOut, TMat>(
                flow.SplitWhen(substreamCancelStrategy, predicate, (f, s) => ((Flow<TIn, Source<TOut, NotUsed>, TMat>) f).To(s)));
        }
        ...
        {
            return new FlowSubFlowImpl<TIn, TOut, TMat>(
                flow.SplitAfter(substreamCancelStrategy, predicate, (f, s) => ((Flow<TIn, Source<TOut, NotUsed>, TMat>) f).To(s)));
        }
